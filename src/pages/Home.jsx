      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
            Créez des <span className="text-yellow-400">Événements</span> Inoubliables
          </h1>
          <p className="text-xl text-zinc-300 mb-8 max-w-xl mx-auto">
            Glow gracious Events vous accompagne dans la création d'expériences exceptionnelles. 
            De la planification à l'exécution, nous rendons vos rêves réalité.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/events" className="btn-primary text-lg px-4 py-4">
              Découvrir nos événements
            </Link>
            <button className="btn-blue text-lg px-4 py-4 flex items-center justify-center">
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Classic Events */}
            <div className="card group hover:border-yellow-400 transition-colors">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Événements Classiques</h3>
              ...
              <Link to="/events" className="text-yellow-400 hover:text-yellow-300 flex items-center">
                En savoir plus <FaArrowRight className="ml-2" />
              </Link>
            </div>

            {/* Modern Events */}
            <div className="card-blue group hover:border-blue-800 transition-colors">
              <div className="w-16 h-16 bg-blue-800 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              ...
              <Link to="/events" className="text-blue-800 hover:text-blue-700 flex items-center">
                En savoir plus <FaArrowRight className="ml-2" />
              </Link>
            </div>
